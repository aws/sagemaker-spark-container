...
from smspark.nginx_utils import start_nginx
from smspark.nginx_utils import write_nginx_default_conf
from smspark.nginx_utils import copy_nginx_default_conf
from smspark.nginx_utils import NGINX_CONTAINER_DEFAULT_CONFIG_PATH
from smspark.nginx_utils import NGINX_DEFAULT_CONFIG_PATH
from smspark.nginx_utils import NGINX_CONTAINER_CONFIG_PATH
from smspark.nginx_utils import NGINX_CONFIG_PATH
from smspark.nginx_utils import NGINX_ENV_VARIABLE_CONFIG_FORMAT
from smspark.nginx_utils import DOMAIN_LOCALHOST
...
def test_start_nginx(mock_subprocess_run,
                     mock_write_nginx_default_conf,
                     mock_copy_nginx_default_conf):
